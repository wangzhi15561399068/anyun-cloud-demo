...
public class RegistryModule extends AbstractModule {
    ...
    public RegistryModule(RegistryOptions options) {
    ...
    protected void configure() {
        ...
        EtcdExtenedService etcdExtenedService = new EtcdExtenedServiceImpl(etcdClient);
        bind(EtcdExtenedService.class).toInstance(etcdExtenedService);
